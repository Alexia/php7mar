...
class options
{
    ...
    private $validShortOptions = [
        ...
        'o' => [
            'option'          => self::OPTION_OPTIONAL,
            'value'           => self::VALUE_REQUIRED,
            'comment'         => 'Folders that should be omitted from scanning',
            'description'     => 'A comma separated list of folder to omit from scanning.',
            'example'         => '-o=/data/my-site/vendor,/data/my-site/images"',
            'comma_delimited' => true,
        ],
    ];
